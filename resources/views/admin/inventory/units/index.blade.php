            ...
            <tr>
              ...
              <td>
                <div class="d-flex gap-1">
                  <a href="{{ route('admin.inventory.units.show', $unit) }}" class="nk-action-btn view" title="Detail">
                    <i class='bx bx-show'></i>
                  </a>
                  <a href="{{ route('admin.inventory.units.edit', $unit) }}" class="nk-action-btn edit" title="Edit">
                    <i class='bx bx-edit'></i>
                  </a>
                  <form action="{{ route('admin.inventory.units.destroy', $unit) }}" method="POST" class="m-0"
