              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                    <li><a class="dropdown-item" href="{{ route('admin.inventory.kabel.show', $kabel) }}"><i class='bx bx-show'></i> Detail</a></li>
                    <li><a class="dropdown-item" href="{{ route('admin.inventory.kabel.edit', $kabel) }}"><i class='bx bx-edit'></i> Edit Haspel</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                      <form action="{{ route('admin.inventory.kabel.destroy', $kabel) }}" method="POST" class="m-0" onsubmit="return confirm('Hapus haspel ini?')">
                        @csrf @method('DELETE')
