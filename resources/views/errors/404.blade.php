...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .badge{width:60px;height:60px;border-radius:20px;display:flex;align-items:center;justify-content:center;background:var(--blue-soft);color:var(--blue);font-size:1.6rem;border:1px solid #bfdbfe;flex-shrink:0}
  .code{font-size:4.8rem;line-height:.9;font-weight:900;color:var(--blue);letter-spacing:-.05em}
