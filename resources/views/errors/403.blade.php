...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .nk-logo{font-size:1.1rem;font-weight:900;letter-spacing:.1em;color:#ef4444;margin-bottom:20px;text-transform:uppercase;}
  .nk-logo span{color:#f1f5f9;}

  .code{font-size:8rem;font-weight:900;line-height:1;background:linear-gradient(135deg,#f87171,#dc2626);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-bottom:8px;filter:drop-shadow(0 10px 20px rgba(220,38,38,0.2));}
  ...
  .btn-primary{background:linear-gradient(135deg,#ef4444,#b91c1c);color:#fff;box-shadow: 0 8px 20px rgba(239, 68, 68, 0.3);border:1px solid rgba(255,255,255,0.1);}
  .btn-primary:hover{transform:translateY(-3px);box-shadow: 0 12px 25px rgba(239, 68, 68, 0.4);filter:brightness(1.1);}
...
<div class="wrap">
  ...
  <div class="msg">Kamu tidak memiliki izin untuk mengakses halaman ini. Jika merasa ini adalah kesalahan, silakan hubungi administrator.</div>
  <div class="actions">
