...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .face.top    { transform: rotateX(90deg) translateZ(40px); background: rgba(217, 119, 6, 0.04); }
  .face.bottom { transform: rotateX(-90deg) translateZ(40px); background: rgba(217, 119, 6, 0.04); }
    ...
    <div class="error-container">
      ...
      <div class="cube-container">
        <div class="cube-wrapper">
          <div class="cube">
            <div class="face front">403</div>
            <div class="face back">403</div>
