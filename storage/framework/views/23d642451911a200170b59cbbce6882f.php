...
<?php $__env->startSection('title', 'Manajemen PPPoE'); ?>
    ...
    <div class="ms-panel">
        <div class="ms-panel-head">
            ...
            <div class="ms-toolbar-right">
                ...
                <span class="ms-chip" style="color:var(--blue);border-color:color-mix(in srgb,var(--blue) 25%,var(--border));background:color-mix(in srgb,var(--blue) 8%,var(--surface));">
                    <i class='bx bx-check-circle'></i> <?php echo e($selectedArea->name); ?>
        ...
        <div class="ms-panel-body">
            <div class="router-kanban">
                ...
                <?php $isActive = $selectedArea?->id == $area->id; ?>
                <a href="<?php echo e(route('admin.pppoe.index', ['area_id' => $area->id])); ?>"
                   class="router-card <?php echo e($isActive ? 'router-card--active' : ''); ?>">
                    ...
                    <div class="router-card-ip"><?php echo e($area->router_ip); ?></div>
                </a>
    ...
    <div class="ms-stat-grid">
        <div class="ms-stat-card" style="--stat-accent:var(--blue);--stat-bg:color-mix(in srgb,var(--blue) 8%,var(--surface));">
            ...
            <div>
                ...
                <div class="ms-stat-value" style="font-size:1.05rem;line-height:1.2;"><?php echo e($routerInfo['identity'] ?? '-'); ?></div>
                <div class="ms-stat-meta"><?php echo e($selectedArea->router_ip); ?></div>
            </div>
        </div>
        <div class="ms-stat-card" style="--stat-accent:var(--orange,#f97316);--stat-bg:color-mix(in srgb,var(--orange,#f97316) 8%,var(--surface));">
            ...
            <div>
                ...
                <div class="ms-stat-value"><?php echo e($totalSecrets); ?></div>
                <?php if($disabledCount > 0): ?>
                <div class="ms-stat-meta"><?php echo e($disabledCount); ?> dinonaktifkan</div>
                <?php endif; ?>
            </div>
        </div>
        <div class="ms-stat-card" style="--stat-accent:var(--green);--stat-bg:color-mix(in srgb,var(--green) 8%,var(--surface));">
            ...
            <div>
                ...
                <div class="ms-stat-value" style="color:var(--green);"><?php echo e($activeCount); ?></div>
                <div class="ms-stat-meta"><?php echo e($onlinePct); ?>% rasio online</div>
            </div>
            <div class="ms-auto" style="width:72px;">
                <div class="pppoe-health-bar"><div class="pppoe-health-fill" style="width:<?php echo e($onlinePct); ?>%;"></div></div>
            </div>
        </div>
        <div class="ms-stat-card" style="--stat-accent:var(--red,#ef4444);--stat-bg:color-mix(in srgb,var(--red,#ef4444) 8%,var(--surface));">
            ...
            <div>
                ...
                <div class="ms-stat-value" style="color:var(--red,#ef4444);"><?php echo e($offlineCount); ?></div>
    ...
    <div class="ms-panel">
        <div class="ms-panel-head">
            <div>
                ...
                <div class="ms-panel-subtitle"><?php echo e($selectedArea->name); ?> — <?php echo e($totalSecrets); ?> secret</div>
            </div>
            <div class="ms-toolbar-right">
                <form method="POST" action="<?php echo e(route('admin.pppoe.sync-customers')); ?>" class="d-inline"
                    data-confirm="Import semua PPPoE secrets dari MikroTik ke database Customers?">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="area_id" value="<?php echo e($selectedArea->id); ?>">
        ...
        <div class="ms-panel-body" style="padding-bottom:.25rem;">
            ...
            <div class="pppoe-filter-pills">
                <span class="pppoe-pill active" data-filter="all">Semua (<?php echo e($totalSecrets); ?>)</span>
                <span class="pppoe-pill" data-filter="online">Online (<?php echo e($activeCount); ?>)</span>
                <span class="pppoe-pill" data-filter="offline">Offline (<?php echo e($offlineCount); ?>)</span>
                <?php if($disabledCount > 0): ?>
                <span class="pppoe-pill" data-filter="disabled">Disabled (<?php echo e($disabledCount); ?>)</span>
                <?php endif; ?>
            </div>
        </div>

        <div class="ms-panel-body" style="padding-top:0;">
            <?php if($totalSecrets === 0): ?>
            ...
            <div class="pppoe-kanban" id="pppoe-kanban">
                ...
                ?>
                <div class="pppoe-card pppoe-card--<?php echo e($cardState); ?>"
                     data-state="<?php echo e($cardState); ?>"
                     data-search="<?php echo e(strtolower($secret['name'] . ' ' . ($secret['profile'] ?? '') . ' ' . ($secret['comment'] ?? '') . ' ' . ($session['address'] ?? '') . ' ' . ($session['caller-id'] ?? ''))); ?>">
                    ...
                    <div class="pppoe-card-name">
                        ...
                        <?php endif; ?>
                        <?php echo e($secret['name']); ?>

                    </div>

                    <?php if($secret['comment'] ?? ''): ?>
                    <div class="pppoe-card-comment">
                        <i class='bx bx-user' style="font-size:.7rem;"></i>
                        <?php echo e($secret['comment']); ?>

                    </div>
                    <?php endif; ?>

                    <div class="pppoe-card-row">
                        <code style="font-size:.72rem;padding:.1rem .35rem;background:var(--surface-2);border-radius:4px;border:1px solid var(--border);"><?php echo e($secret['profile'] ?? 'default'); ?></code>
                        <?php if($isDisabled): ?>
                    ...
                    <div class="pppoe-card-traffic">
                        <span class="pppoe-card-traffic-rx">
                            <i class='bx bx-down-arrow-alt'></i><?php echo e($fmtBytes($session['bytes-in'] ?? 0)); ?>

                        </span>
                        <span style="color:var(--border);">|</span>
                        <span class="pppoe-card-traffic-tx">
                            <i class='bx bx-up-arrow-alt'></i><?php echo e($fmtBytes($session['bytes-out'] ?? 0)); ?>

                        </span>
                    </div>
                    <div class="pppoe-card-row" style="gap:.2rem;">
                        <?php if($session['uptime'] ?? ''): ?>
                        <span class="pppoe-card-uptime">
                            <i class='bx bx-time' style="font-size:.7rem;"></i><?php echo e($session['uptime']); ?>

                        </span>
                        <?php endif; ?>
                        <?php if($session['caller-id'] ?? ''): ?>
                        <span class="pppoe-card-caller">
                            <i class='bx bx-wifi' style="font-size:.65rem;"></i><?php echo e($session['caller-id']); ?>
                    ...
                    <div class="pppoe-card-actions">
                        <form method="POST" action="<?php echo e(route('admin.pppoe.toggle')); ?>" style="flex:1;display:contents;">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="area_id" value="<?php echo e($selectedArea->id); ?>">
                            <input type="hidden" name="username" value="<?php echo e($secret['name']); ?>">
                            <input type="hidden" name="enable" value="<?php echo e($isDisabled ? '1' : '0'); ?>">
                            <button type="submit"
                                class="pppoe-card-btn <?php echo e($isDisabled ? 'pppoe-card-btn--enable' : ''); ?>"
                                title="<?php echo e($isDisabled ? 'Aktifkan' : 'Nonaktifkan'); ?>"
                                style="flex:1;">
                                <i class='bx <?php echo e($isDisabled ? "bx-play-circle" : "bx-pause-circle"); ?>'></i>
                                <span style="font-size:.7rem;"><?php echo e($isDisabled ? 'Aktifkan' : 'Pause'); ?></span>
                            </button>
                        </form>
                        <?php if($isActive): ?>
                        <form method="POST" action="<?php echo e(route('admin.pppoe.disconnect')); ?>" style="flex:1;display:contents;"
                            data-confirm="Putuskan sesi PPPoE <?php echo e($secret['name']); ?>?">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="area_id" value="<?php echo e($selectedArea->id); ?>">
                            <input type="hidden" name="username" value="<?php echo e($secret['name']); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/netking.id/resources/views/admin/pppoe/index.blade.php ENDPATH**/ ?>