...
<head>
  ...
  <meta property="og:image" content="<?php echo e(asset('img/NetkingLoginBaruLight.png')); ?>">
  ...
  {"@context":"https://schema.org","@type":"LocalBusiness","@id":"<?php echo e(url('/')); ?>","name":"Netking","description":"Penyedia layanan internet untuk segmen residensial dan bisnis. Jaringan milik sendiri, monitoring 24/7, teknisi lokal.","url":"<?php echo e(url('/')); ?>","logo":"<?php echo e(asset('img/NetkingLoginBaruLight.png')); ?>","priceRange":"Rp 100.000 – Rp 150.000","serviceType":"Layanan Internet Rumah","areaServed":"Indonesia"}
  </script>
...
<nav id="main-nav">
  <a href="<?php echo e(route('landing')); ?>" class="nav-logo" aria-label="Netking">
    <span class="nav-logo-text">Netking</span>
  </a>
  <div class="nav-links" id="nav-links">
    <a href="<?php echo e(route('landing')); ?>">Beranda</a>
          ...
          <div class="ip-screen" id="hp-tagihan" style="display:none;">
            ...
            <div style="padding:.65rem .85rem;background:#f1f5f9;">
              ...
              <div style="background:#fff;border-radius:12px;padding:.3rem .7rem;box-shadow:0 1px 4px rgba(15,23,42,.08);">
                <?php $__currentLoopData = [['April 2026','Rp 150.000','Belum Dibayar',false],['Maret 2026','Rp 150.000','Lunas',true],['Feb 2026','Rp 150.000','Lunas',true],['Jan 2026','Rp 150.000','Lunas',true],['Des 2025','Rp 125.000','Lunas',true]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$bln,$nom,$st,$ok]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div style="display:flex;align-items:center;justify-content:space-between;padding:.42rem 0;border-bottom:1px solid #f1f5f9;">
                  <div><div style="font-size:.67rem;font-weight:600;color:var(--txt);"><?php echo e($bln); ?></div><div style="font-size:.58rem;color:var(--txt3);"><?php echo e($nom); ?></div></div>
                  <?php if($ok): ?><span style="font-size:.55rem;padding:.1rem .42rem;border-radius:100px;background:#dcfce7;color:#16a34a;font-weight:700;"><?php echo e($st); ?></span>
                  <?php else: ?><span style="font-size:.55rem;padding:.1rem .42rem;border-radius:100px;background:#fef9c3;color:#a16207;font-weight:700;"><?php echo e($st); ?></span><?php endif; ?>
                </div>
...
<footer>
  <div class="foot-inner">
    ...
    <div class="foot-copy">&copy; <?php echo e(date('Y')); ?> Netking. Semua hak dilindungi.</div>
  </div>
</footer>
...
<?php /**PATH /var/www/netking.id/resources/views/landing.blade.php ENDPATH**/ ?>