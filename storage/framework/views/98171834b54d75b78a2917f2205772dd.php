  ...
  <div class="sb-linear-actions">
    <div class="dropdown">
      <button class="sb-user-trigger" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-label="User menu">
        <span class="sb-linear-mark sb-user-mark"><?php echo e($userInitials); ?></span>
        <i class='bx bx-chevron-down sb-linear-caret'></i>
      </button>
      <div class="dropdown-menu sb-user-menu">
        <div class="sb-user-menu-head">
          <div class="sb-user-menu-name"><?php echo e($sidebarUser?->name ?? 'Admin'); ?></div>
          <div class="sb-user-menu-role"><?php echo e(ucfirst($sidebarUser?->role ?? 'admin')); ?></div>
        </div>
        <a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>"><i class='bx bx-user me-2'></i>Profil</a>
        <?php if($isAdmin): ?>
        <a class="dropdown-item" href="<?php echo e(route('admin.settings')); ?>"><i class='bx bx-cog me-2'></i>Pengaturan</a>
        <?php endif; ?>
...
<a href="<?php echo e(route('admin.dashboard')); ?>"
   class="sb-link <?php echo e($dashboardActive ? 'active' : ''); ?>"
...
?>
  <details class="sb-group" <?php echo e($sectionActive ? 'open' : ''); ?>>
    <summary class="sb-group-summary">
      <span class="sb-group-label"><?php echo e($section['label']); ?></span>
    ...
    <div class="sb-group-items">
      ...
      <a href="<?php echo e($item['url'] ?? $item['route']); ?>"
         class="sb-link <?php echo e($item['active'] ? 'active' : ''); ?>"
         data-title="<?php echo e($item['title']); ?>"
         <?php if(isset($item['target'])): ?> target="<?php echo e($item['target']); ?>" rel="noopener noreferrer" <?php endif; ?>>
        <span class="sb-icon-wrap">
          <i class="<?php echo e($item['icon']); ?> sb-icon"></i>
        </span>
        <span class="sb-link-copy">
          <span class="sb-link-title"><?php echo e($item['title']); ?></span>
          <?php if(!empty($item['badge'])): ?>
            <span style="background:var(--red);color:#fff;font-size:.65rem;font-weight:700;padding:1px 6px;border-radius:10px;margin-left:6px;line-height:1.4;"><?php echo e($item['badge']); ?></span>
          <?php endif; ?>
          <?php if(isset($item['target'])): ?><i class='bx bx-link-external' style="font-size:.65rem;opacity:.5;margin-left:3px;"></i><?php endif; ?>
        </span>
      </a>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /var/www/netking.id/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>