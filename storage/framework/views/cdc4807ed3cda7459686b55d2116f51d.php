...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .code{font-size:8rem;font-weight:900;line-height:1;background:linear-gradient(135deg,#6366f1,#8b5cf6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
...
<div class="wrap">
  ...
  <div class="msg">Halaman yang Anda cari tidak ada atau sudah dipindahkan.<br>Periksa URL atau kembali ke dashboard.</div>
  <div class="actions">
...
<?php /**PATH /var/www/netking.id/resources/views/errors/404.blade.php ENDPATH**/ ?>