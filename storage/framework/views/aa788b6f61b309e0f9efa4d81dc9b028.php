    ...
    <div class="container-fluid">
        ...
        <div class="navbar-nav flex-row d-lg-none">
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown">
                    <span class="avatar avatar-sm" style="background-image: url(https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name ?? 'Admin')); ?>&background=206bc4&color=fff)"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="dropdown-item">Dasbor</a>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <?php if($role === 'admin'): ?>
                <li class="nav-item <?php echo e(request()->routeIs('admin.areas.*') ? 'active' : ''); ?>">
                ...
                <?php if(\Illuminate\Support\Facades\Route::has('admin.partners.index')): ?>
                <li class="nav-item <?php echo e(request()->routeIs('admin.partners.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item <?php echo e(request()->routeIs('admin.customers.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item <?php echo e(request()->routeIs('admin.invoices.*') || request()->routeIs('admin.billing.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item <?php echo e(request()->routeIs('admin.billing.*') ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('admin.billing.calendar.view')); ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <?php if($role === 'admin'): ?>
                <li class="nav-item <?php echo e(request()->routeIs('admin.commissions.*') ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('admin.commissions.index')); ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item <?php echo e(request()->routeIs('admin.telegram.requests.*') ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('admin.telegram.requests.index')); ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
...
<?php /**PATH /var/www/netking.id/resources/views/admin/layout/sidebar.blade.php ENDPATH**/ ?>