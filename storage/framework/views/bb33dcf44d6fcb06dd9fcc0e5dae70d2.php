...
<?php $__env->startSection('title', 'NMS Topology'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div id="routerList" style="max-height:280px;overflow-y:auto;">
                    ...
                    <div class="router-list-item" onclick="focusNode('area_<?php echo e($area->id); ?>')"
                        ...
                        <div style="font-weight:600;"><?php echo e($area->name); ?></div>
                        <div style="color:var(--text-muted);font-size:.7rem;"><?php echo e($area->router_ip); ?></div>
                    </div>
...
async function loadTopology() {
    ...
    try {
        const res  = await fetch('<?php echo e(route("admin.nms.topology.data")); ?>');
...
function showNodeDetail(node) {
    ...
    document.getElementById('nodeDetail').innerHTML = `
        ...
        ${node.group === 'router' ? `<a href="<?php echo e(route('admin.nms.diagnostics')); ?>?area=${d.id?.replace('area_','')}" class="btn btn-sm mt-2 w-100" style="background:rgba(249,115,22,.12);color:var(--orange);border:1px solid var(--orange);font-size:.72rem;"><i class='bx bx-terminal me-1'></i>Diagnostics</a>` : ''}
    `;
}
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/netking.id/resources/views/admin/nms/nms_topology.blade.php ENDPATH**/ ?>