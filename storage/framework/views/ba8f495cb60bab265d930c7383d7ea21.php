...
<head>
  ...
  <title><?php echo $__env->yieldContent('title','Dasbor'); ?></title>
...
<script>
  ...
  <header class="topbar">
    ...
    <span class="tb-title"><?php echo $__env->yieldContent('title', 'Dasbor'); ?></span>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-end notif-menu" id="notif-dropdown">
        ...
        <div class="notif-panel-footer d-flex align-items-center justify-content-between gap-2">
          ...
          <a href="<?php echo e(route('admin.activity-log')); ?>" style="font-size:.75rem;color:var(--blue);text-decoration:none;">Lihat Log Aktivitas →</a>
        </div>
      </div>
    </div>
  ...
  <main class="main">
    ...
    <div class="alert alert-warning alert-dismissible fade show mb-3">
      <i class='bx bx-info-circle me-1'></i><?php echo e(session('warning')); ?>
    ...
    <div class="alert alert-danger alert-dismissible fade show mb-3">
      ...
      <ul class="mb-0 mt-1 ps-3"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($e); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
      <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    </div>
    <?php endif; ?>
...
<?php /**PATH /var/www/netking.id/resources/views/layouts/app.blade.php ENDPATH**/ ?>