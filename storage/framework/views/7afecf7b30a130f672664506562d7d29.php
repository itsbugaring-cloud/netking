...
<body>
  ...
  <div class="auth-shell">
    ...
    <form action="<?php echo e(route('admin.login.post')); ?>" method="POST" autocomplete="off">
      <?php echo csrf_field(); ?>

      <?php if($errors->any()): ?>
      <div class="auth-alert auth-alert-danger">
        <i class='bx bx-error-circle' style="font-size:1.1rem;flex-shrink:0;"></i>
        <div><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($err); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
      </div>
      <?php endif; ?>
      <?php if(session('status')): ?>
      <div class="auth-alert auth-alert-success">
        <i class='bx bx-check-circle' style="font-size:1.1rem;flex-shrink:0;"></i> <?php echo e(session('status')); ?>
      ...
      <div class="form-group">
        ...
        <input type="email" id="email" name="email" class="form-input"
          value="<?php echo e(old('email')); ?>" placeholder="Masukkan email" autofocus>
      </div>
...
<?php /**PATH /var/www/netking.id/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>